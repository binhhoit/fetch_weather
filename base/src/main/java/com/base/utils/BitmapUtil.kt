    ...
    companion object {
        ...
        private fun compressImageFile(context: Context, imageFile: File, reqWidth: Int, reqHeight: Int): File {
            ...
            try {
                ...
                decodeBitmapFromExitFile(imageFile, reqWidth, reqHeight).compress(Bitmap.CompressFormat.JPEG, 50, fileOutputStream)
        ...
        fun rotationBitmap(filePath: String, bm: Bitmap): Bitmap {
        ...
        fun decodeBitmapFromExitPath(path: String, reqWidth: Int = 0, reqHeight: Int = 0, bitmapConfig: Bitmap.Config = Bitmap.Config.RGB_565, crop: Boolean = false): Bitmap {
            val opts = BitmapFactory.Options()
        ...
        fun decodeBitmapFromExitFile(file: File, reqWidth: Int, reqHeight: Int, bitmapConfig: Bitmap.Config = Bitmap.Config.RGB_565, crop: Boolean = false): Bitmap {
