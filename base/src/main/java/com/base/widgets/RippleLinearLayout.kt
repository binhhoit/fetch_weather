...
class RippleLinearLayout : LinearLayout {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            val leftTopCornerRadius = a.getDimensionPixelSize(R.styleable.RippleLinearLayout_rll_left_top_corner, CORNER_RADIUS)
            val rightTopCornerRadius = a.getDimensionPixelSize(R.styleable.RippleLinearLayout_rll_right_top_corner, CORNER_RADIUS)
            val leftBottomCornerRadius = a.getDimensionPixelSize(R.styleable.RippleLinearLayout_rll_left_bottom_corner, CORNER_RADIUS)
            val rightBottomCornerRadius = a.getDimensionPixelSize(R.styleable.RippleLinearLayout_rll_right_bottom_corner, CORNER_RADIUS)
