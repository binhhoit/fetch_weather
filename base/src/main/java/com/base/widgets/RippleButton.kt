...
class RippleButton : AppCompatButton {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        ...
        val leftBottomCornerRadius = a.getDimensionPixelSize(R.styleable.RippleButton_rb_left_bottom_corner, CORNER_RADIUS)
        val rightBottomCornerRadius = a.getDimensionPixelSize(R.styleable.RippleButton_rb_right_bottom_corner, CORNER_RADIUS)
